# try-get-block
try-get-block is a collection of utilities for interacting with Web3 and Ethereum smart contracts.
...
You can try-get-block Project via npm:

```bash
npm install try-get-block
```
## Usage

const Web3Tools = require('try-get-block');
